...
import AccountsModal from "./dependencies/AccountsModal";
const RightSection = () => {
  ...
  // Accounts State
  const [openAccountsModal, setOpenAccountsModal] = useState("close");
  const handleCloseModal = () => {
    setOpenAccountsModal("close");
  };
  return (
    <>
      ...
      {openAccountsModal == "open" && (
        <div className="absolute right-0 top-0 bg-primaryBlack bg-opacity-50 w-full h-full z-[500]">
          <AccountsModal func={handleCloseModal} />
        </div>
      )}
    </>
  );
